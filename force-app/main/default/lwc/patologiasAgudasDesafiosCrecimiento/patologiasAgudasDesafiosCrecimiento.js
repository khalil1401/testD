...
export default class PatologiasAgudasDesafiosCrecimiento extends LightningElement {

    patologias = [ 
        {id: '0', name: 'traumatismos'},
        {id: '1', name: 'cirugia'},
        {id: '2', name: 'quemaduras'},
        {id: '3', name: 'patologias-infecciosas'},
    ];
    selectedPatologia;
    showArrows;
    disabledNext;
